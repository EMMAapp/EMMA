...
export default ({option1, option2, selected, setSelected, style, height, width, middleSpan}) =>
    <Row style={style}>
        ...
        <TouchableOpacity activeOpacity={1} onPress={() => setSelected(2)} style={marginStyle(middleSpan || 0, 'left')}>
